...
# Start service
docker compose -f comps/lvms/src/integrations/dependency/video-llama/docker_compose_vllama.yaml -d
...
```yaml
# comps/lvms/src/integrations/dependency/video-llama/docker_compose_vllama.yaml
services:
  lvm-video-llama:
    ...
    environment:
